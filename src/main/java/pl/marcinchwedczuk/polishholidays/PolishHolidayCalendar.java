...
class PolishHolidayCalendar {
  private final PolishHolidayDefinition newYear =
      PolishHolidayDefinition.create(
          rules -> {
            rules
                .newRule()
  ...
  private final PolishHolidayDefinition epiphany =
      PolishHolidayDefinition.create(
          rules -> {
            PolishHolidayDefinitionRuleBuilder ruleTemplate =
                rules
                    .newRule()
            ...
            /* Wiki: https://pl.wikipedia.org/wiki/Objawienie_Pa%C5%84skie
              ...
              od pracy.
            */
            ruleTemplate.validUntilYearExcluding(2011).add();

            ruleTemplate.validFromYearIncluding(2011).markAsPublicHoliday().add();
          });
